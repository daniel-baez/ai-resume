...
export function Experience({ experienceEntries, currentLang }: ExperienceProps) {
  ...
  return (
    <Card
      id="experience"
      className="bg-white bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-lg rounded-2xl transition-all duration-300 hover:shadow-xl border border-blue-100"
    >
      <CardHeader>
          ...
          <div key={index}>
            ...
            <ReactMarkdown
              ...
              components={{
                ul: ({ ...props }) => (
                  <ul
                    className="list-disc list-inside text-gray-800 leading-relaxed"
                    {...props}
                  />
                ),
                ol: ({ ...props }) => (
                  <ol
                    className="list-decimal list-inside text-gray-800 leading-relaxed"
                    {...props}
                  />
                ),
                li: ({ ...props }) => (
                ...
                b: ({ ...props }) => (
                  <b className="text-gray-800 leading-relaxed" {...props} />
                ),
                strong: ({ ...props }) => (
                  <strong
